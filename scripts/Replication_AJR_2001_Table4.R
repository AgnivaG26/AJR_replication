...
# --- 4. Generate Table for Panel A (2SLS Results) ---
print(modelsummary(
  iv_models,
  output = "gt",
...
# --- 5. Generate Table for Panel B (First Stage Results) ---

# --- THIS IS THE CORRECTED LINE ---
# Use `$` to access the first-stage model from the fixest object
